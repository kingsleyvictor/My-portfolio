        ...
        <section className="relative py-24 px-4 md:px-8 lg:px-16 overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto relative">
                ...
                >
                    ...
                    <div className="h-1 w-24 bg-gradient-to-r from-sky-500 to-blue-500 mb-6" />
                    ...
                    {projects.map((project, index) => (
                        ...
                        >
                            ...
                            <div className="relative p-8 flex flex-col h-full">
                                ...
                                <div className="h-[2px] w-full bg-gradient-to-r from-sky-500/50 to-blue-500/50 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500 absolute bottom-0 left-0" />
                            </div>
                        </motion.div>
                    ))}
                </div>

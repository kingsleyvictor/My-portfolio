    ...
    <section className="mx-[30px] mt-[60px] pb-[20px] lg:pb-[50px] lg:mx-[76px] lg:mt-[150px]">
      ...
      <div className="mt-[63px] flex flex-col-reverse justify-start gap-5 md:gap-0 md:flex md:flex-row md:justify-between md:items-center ">
        ...
        <div className="mt-[10px] md:mt-[65px] flex justify-start items-center gap-[20px] md:gap-[40px]">
          <motion.a
            href="https://www.youtube.com/@victor_codes"
            target="_blank"
            rel="noreferrer"
            whileTap={{ scale: 1.1 }}
          ...
          <motion.a
            href="https://x.com/victor_can_code"
            target="_blank"
            rel="noreferrer"
            whileTap={{ scale: 1.1 }}
            whileHover={{ scale: 0.99 }}
          ...
          <motion.a
            href="https://www.instagram.com/victor_codes2/"
            target="_blank"
            rel="noreferrer"
            whileTap={{ scale: 1.1 }}
            whileHover={{ scale: 0.99 }}
          ...
          <motion.a
            href="https://www.linkedin.com/in/kingsleyvictor/"
            target="_blank"
            rel="noreferrer"
            whileTap={{ scale: 1.1 }}
            whileHover={{ scale: 0.99 }}

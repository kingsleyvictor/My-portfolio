    ...
    return (
        <>
            <main className="">
                <header
                    className={clsx(
                        "fixed z-40 top-0 md:relatives bg-[#03002b]/90 pb-3  w-full pt-[20px] px-[32px] md:py-[30px] lg:px-[80px]"
                    )}
                >
                    <nav className="flex items-center justify-between">
                        ...
                        <div className="text-[#FFFFFF99] group group-hover:text-white transition-all duration-300">
                            <Link
                                target="_blank"
                                rel="noreferrer"
                                href="https://github.com/kingsleyvictor"
